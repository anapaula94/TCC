...
<head>
	<meta charset="utf-8">
	<title>Média por NºQuartos</title>
	<!-- Required meta tags -->
    <meta charset="utf-8">
...
<body>
	<div class="container-fluid" s style="background-image: url(bg.jpg);">
...
$sql = "SELECT AVG(round(valorBD)) FROM apartamento WHERE quartoBD='$quarto'";
